...
# -*- coding: utf-8 -*-
"""
ByT5 ARPABET → Korean 음차 변환 파인튜닝 스크립트
ARPABET 발음기호를 한글 음차로 변환하는 모델을 학습합니다.
"""
...
DATA_PATH = "./dataset/training_arpabet.json"
OUTPUT_DIR = "./models/byt5-arpabet2kor"
CHECKPOINT_DIR = "./checkpoints_arpabet"

# 하이퍼파라미터
LEARNING_RATE = 5e-5
BATCH_SIZE = 8
GRADIENT_ACCUMULATION_STEPS = 4
NUM_EPOCHS = 10  # ARPABET은 패턴이 단순하므로 더 많은 에폭
MAX_INPUT_LENGTH = 256  # ARPABET은 길이가 길 수 있음
...
def main():
    print("=" * 60)
    print("ByT5 ARPABET->Korean Transliteration Fine-tuning")
    print("=" * 60)
    ...
    # 테스트 데이터 저장
    test_dataset.to_json("./test_data_arpabet.json")
    print("Test data saved: ./test_data_arpabet.json")
